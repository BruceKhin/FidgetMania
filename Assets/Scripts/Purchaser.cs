...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    private static string kProductNameAppleNonConsumable =  "com.game.thing.benjamin";

    // Google Play Store-specific product identifier subscription product.
    private static string kProductNameGooglePlayNonConsumable =  "com.game.thing.benjamin"; 

    void Start()
    {
        Debug.Log("starting unity purchasing");
    ...
    public void RestorePurchases()
    {
            ...
            Application.platform == RuntimePlatform.OSXPlayer)
        {
            ...
            try
            {
                Debug.Log("storeextension provider: " + m_StoreExtensionProvider);
                // Fetch the Apple store-specific subsystem.
                var apple = m_StoreExtensionProvider.GetExtension<IAppleExtensions>();
                Debug.Log ("apple extension:" + apple);
            ...
            {
                Debug.Log ("apple extension not found");
